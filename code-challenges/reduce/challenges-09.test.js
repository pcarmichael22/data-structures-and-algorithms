...
------------------------------------------------------------------------------------------------ */
// const reducer = (accumulator) => accumulator + 1;
// let test = arr.reduce(reducer);
// return test

const countNumberOfElements = (arr) => {
    // let test = arr.reduce(function(accumulator) {
    //     return accumulator + 1;
    // })
    let test = arr.reduce(accumulator => {
        return accumulator + 1;
    })
    return test;
...
const returnNames = (arr) => {
    let namesArr = arr.reduce((accumulator, current) => {
...
const reversedString = (str) => {
    let test = str.split('').reduce((accumulator, value) => {
...
const countNumberOfChildren = (arr) => {
    let test = arr.reduce((accumulator, character) => {
